        ...
        <div id="wrapper">
            <section class="panel color2-alt">
                ...
                <div class="span-4-5">
                    ...
                    <form method="POST" action="myQuiz/public/index.php/Home/login">
                        <div class="field">
                            <label for="email">Email</label>
                            <input type="email" name="email" id="email" value="" placeholder="Kérem írja be az email címét!" />
                        </div>
                        <div class="field">
                        ...
                        <ul class="actions">
                            <li><button type="submit" class="special color2" >Belépés</button></li>
                        </ul>
                    </form>
                </div>
            </section>
